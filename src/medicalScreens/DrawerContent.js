...
export const  MDrawerContent = ({props, navigation, userData}) => {
    ...
    // onPress={() => navigation.navigate('DoctorProfileScreen', {clinic: true})} 
    return(
                ...
                <View style={styles.drawerContent}>
                    <View style={styles.userInfoSection}>
                        ...
                        <View style={{flexDirection:'row', alignItems: 'center', justifyContent: 'center'}}>
                            ...
                            <Entypo.Button color={'#ffffff'} onPress={() => navigation.navigate('MedicalProfileScreen')} backgroundColor="#00B2B6" name="edit"/>
                        </View>
                    ...
                    <Drawer.Section style={styles.drawerSection}>
                        ...
                        <DrawerItem 
                            ...
                            label={"Order History"}
                            labelStyle={{color: '#ffffff'}}
                            onPress={() => {navigation.navigate('InquiriesHistory')}}
                        />
                        <DrawerItem 
                            icon={({color, size}) => (
                                <Icon 
